...
export default function Footer() {
  return (
    <footer className="bg-[#020617] border-t border-white/5 text-slate-400 pt-14 pb-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 mb-12">
          ...
          <div className="space-y-4">
            <div>
              <span className="font-black text-2xl text-white">YA</span>
            ...
            <div className="flex gap-2.5">
              {socials.map(({ icon, href, label }) => (
                <a
                  ...
                  rel="noreferrer"
                  aria-label={label}
                  className="w-9 h-9 bg-white/5 border border-white/10 rounded-lg flex items-center justify-center hover:bg-[#2563EB] hover:border-[#2563EB] hover:text-white transition-all duration-200"
                >
                  {icon}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {quickLinks.map(({ label, href }) => (
                <li key={label}>
                  <a href={href} className="text-sm text-slate-400 hover:text-[#38BDF8] transition-colors flex items-center gap-1.5 group">
          ...
          {/* Download CVs */}
          <div>
            <p className="text-white font-bold text-sm mb-4 uppercase tracking-widest">Download CV</p>
            <div className="space-y-3">
              <a
                href="/cv/Yokarasaa-Paviyaalan-Digital-Marketing-CV.pdf"
                download
                className="flex items-center gap-2.5 px-4 py-3 bg-[#2563EB]/10 border border-[#2563EB]/30 rounded-xl text-sm font-semibold text-[#38BDF8] hover:bg-[#2563EB]/20 hover:border-[#2563EB]/60 transition-all group"
              >
              ...
              <a
                ...
                download
                className="flex items-center gap-2.5 px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-sm font-semibold text-slate-300 hover:bg-white/10 hover:border-white/20 hover:text-white transition-all group"
              >
                <FaDownload size={13} className="group-hover:animate-bounce" />
                QA CV
              </a>
